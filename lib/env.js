...
module.exports = {
  ...
  WATCHER_DUMP_FILE_PATH: process.env.WATCHER_DUMP_FILE_PATH || path.join(__dirname, 'watchers.json'),
  WATCHER_BACKUP_FILE_PATH: process.env.WATCHER_BACKUP_FILE_PATH || path.join(__dirname, 'watchers.backup.json'),
